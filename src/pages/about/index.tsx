      ...
      <section className="u-safe-area">
        <div className="container">
          <div className="prose mx-auto dark:prose-invert md:prose-base md:max-w-screen-sm lg:max-w-screen-md">
            ...
            <h3>Sometimes also use:</h3>
            <ul>
              <li>
                <Link href="https://redux.js.org/">Redux</Link> with{" "}
                <Link href="https://redux-toolkit.js.org/">Redux Toolkit</Link>
              </li>
              <li>
                <Link href="https://gulpjs.com/">GulpJS</Link>
              </li>
              <li>
                <Link href="https://sass-lang.com/">SCSS</Link>
              </li>
              <li>
                <Link href="https://mozilla.github.io/nunjucks/">Nunjucks</Link>
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ORM (<Link href="https://www.prisma.io/">Prisma</Link>)
              </li>
            </ul>
            <h2 className="decoration-slice underline decoration-dashed underline-offset-4">
              Ping me
